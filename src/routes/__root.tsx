...
import { reportAliceError } from "../lib/alice-error-reporting";
...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  useEffect(() => {
    reportAliceError(error, { boundary: "tanstack_root_error_component" });
  }, [error]);
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:site", content: "@alice_agent" },
    ],
    links: [
      {
        rel: "stylesheet",
